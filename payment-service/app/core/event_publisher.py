...
class EventPublisher:
    ...
    async def publish_payment_received(self, payment_data: Dict[str, Any], correlation_id: str = None) -> bool:
        """
        ...
        return await self.publish_event("payment.received", event_data, correlation_id)
    
    async def publish_payment_failed(self, payment_data: Dict[str, Any], correlation_id: str = None) -> bool:
        """
        ...
        return await self.publish_event("payment.failed", event_data, correlation_id)
