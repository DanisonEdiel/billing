...
# Include routers
app.include_router(payment_routes.router, prefix=settings.API_V1_STR)
...
async def shutdown_event():
    ...
    logger.info("Payment Service shutdown successfully")
...
def custom_openapi():
    ...
    openapi_schema = get_openapi(
        title=settings.PROJECT_NAME,
        version="1.0.0",
        description="Payment service API for the Billing domain",
        routes=app.routes,
    )
