#!/usr/bin/env python
"""
Script to run database migrations for payment-service
...
logger = logging.getLogger("payment-service-migrations")
...
db_url = os.environ.get("DATABASE_URL", "postgresql://payment_user:payment_password@localhost:5432/payment_service_db")
