#!/usr/bin/env python
"""
Script to run database migrations for discount-service
...
logger = logging.getLogger("discount-service-migrations")
...
db_url = os.environ.get("DATABASE_URL", "postgresql://discount_user:discount_password@localhost:5432/discount_service_db")
