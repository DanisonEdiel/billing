...
from app.api.routes import discount_routes
...
# Include routers
app.include_router(discount_routes.router, prefix=settings.API_V1_STR)
...
async def startup_event():
    ...
    logger.info("Discount Service started successfully")
...
async def shutdown_event():
    ...
    logger.info("Discount Service shutdown successfully")
...
def custom_openapi():
    ...
    openapi_schema = get_openapi(
        title=settings.PROJECT_NAME,
        version="1.0.0",
        description="Discount service API for the Billing domain",
        routes=app.routes,
    )
