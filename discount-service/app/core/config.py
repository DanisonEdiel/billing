...
class Settings(BaseSettings):
    PROJECT_NAME: str = "Discount Service"
    ...
    # Database
    DATABASE_URL: Optional[PostgresDsn] = os.getenv("DISCOUNT_SERVICE_DATABASE_URL")
    ...
    def assemble_db_connection(cls, v: Optional[str], values: Dict[str, Any]) -> Any:
        ...
        return PostgresDsn.build(
            ...
            path=f"/{os.getenv('DISCOUNT_SERVICE_POSTGRES_DB', 'discount_service_db')}",
        )
