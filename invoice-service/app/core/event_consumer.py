...
class EventConsumer:
    ...
    def __init__(self):
        ...
        self.queue_name = "invoice_service_queue"
        self.event_handlers = {}
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            await queue.bind(exchange, routing_key="payment.received")
...
from app.services.invoice_service import handle_payment_received

# Register handlers
event_consumer.register_handler("payment_received", handle_payment_received)
